	...
	function(e, t, n) {
		...
		function v(e, t) {
			('object' === ('undefined' == typeof HTMLElement ? 'undefined' : u(HTMLElement))
				...
				: e && 'object' === u(e) && null !== e && 1 === e.nodeType && 'string' == typeof e.nodeName) &&
				(e = [ e ]);
												...
												(a = o.extend(
													{
														...
														'background-image':
															o.image.bgImage || 'url("'.concat(o.image.src, '")')
													},
													i,
													a
												))),
							...
							value: function() {
								...
								return (
									i &&
										...
										1 < o
											? (r = Math.abs(a - h))
											: o < 0 ? (r = a / o + Math.abs(a)) : (r += (h - n) * (1 - o)),
										(a /= 2)),
							...
							value: function(e) {
								...
								p.options.elementInViewport &&
									...
									(p.isElementInViewport =
										0 <= y.bottom && 0 <= y.right && y.top <= h && y.left <= b.window.innerWidth),
									(e || p.isElementInViewport) &&
										...
										('scale' !== p.options.type && 'scale-opacity' !== p.options.type) ||
											((c = 1),
											p.options.speed < 0
												? (c -= p.options.speed * s)
												: (c += p.options.speed * (1 - s)),
											(g.transform = 'scale('.concat(c, ') translate3d(0,0,0)'))),
										('scroll' !== p.options.type && 'scroll-opacity' !== p.options.type) ||
