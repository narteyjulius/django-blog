...
!(function(e, t) {
			...
			return this.length > 0
				? e
					? this[0].nextElementSibling && d(this[0].nextElementSibling).is(e)
						...
						: d([])
					: this[0].nextElementSibling ? d([ this[0].nextElementSibling ]) : d([])
				: d([]);
		},
		nextAll: function(e) {
			const t = [];
	...
	function P(e) {
		...
		if (c > a.longSwipesMs) {
			...
			t.navigation && (o.target === t.navigation.nextEl || o.target === t.navigation.prevEl)
				? o.target === t.navigation.nextEl ? t.slideTo(m + v) : t.slideTo(m)
					...
					if (((c = a && e > o ? o : a && e < d ? d : e), r.updateProgress(c), n.cssMode)) {
						...
						if (0 === t) l[e ? 'scrollLeft' : 'scrollTop'] = -c;
							...
							if (!r.support.smoothScroll)
								return v({ swiper: r, targetPosition: -c, side: e ? 'left' : 'top' }), !0;
				...
				slideTo: function(e = 0, t = this.params.speed, s = !0, a, i) {
					...
					if (l.cssMode) {
						...
						if (0 === t) {
							...
							if (!r.support.smoothScroll)
								return v({ swiper: r, targetPosition: s, side: e ? 'left' : 'top' }), !0;
	...
	const J = [
		...
		function({ swiper: e, extendParams: t, on: s, emit: i }) {
			...
			function g() {
				...
				(s[0].style.width = ''),
					...
					(c =
						e.size /
						(e.virtualSize + e.params.slidesOffsetBefore - (e.params.centeredSlides ? e.snapGrid[0] : 0))),
		...
		function({ swiper: e, extendParams: t, on: s }) {
			...
			const a = (t, s) => {
					...
					if (
						(l || o
							? ((l = l || '0'), (o = o || '0'))
							: e.isHorizontal() ? ((l = n), (o = '0')) : ((o = n), (l = '0')),
									...
									if (
										...
										if (r.hasClass(e.params.slideDuplicateClass)) {
											l(
												e.$wrapperEl
													.children(
														`[data-swiper-slide-index="${t}"]:not(.${e.params
															.slideDuplicateClass})`
													)
													.index(),
												!1
											...
											l(
												e.$wrapperEl
													.children(
														`.${e.params
															.slideDuplicateClass}[data-swiper-slide-index="${t}"]`
													)
													.index(),
												!1
											);
		...
		function({ swiper: e, extendParams: t, on: s, emit: i }) {
			...
			function l() {
				return (
					void 0 === r && (!e.autoplay.running && ((e.autoplay.running = !0), i('autoplayStart'), n(), !0))
				);
			}
			function o() {
				return (
		...
		function({ swiper: e, extendParams: t, on: s }) {
			...
			function r() {
				...
				let i;
				if (
					((i = t.params.loop ? parseInt(d(t.clickedSlide).attr('data-swiper-slide-index'), 10) : s),
					e.params.loop)
				) {
					let t = e.activeIndex;
			...
			function n() {
				...
				return (
					e.thumbs.swiper.$el.addClass(e.params.thumbs.thumbsContainerClass), e.thumbs.swiper.on('tap', r), !0
				);
			}
			function l(t) {
					...
					if (s.params.loop) {
						...
						(n =
							void 0 === t
								...
								: void 0 === a
									? t
									: a - o == o - t ? (s.params.slidesPerGroup > 1 ? a : o) : a - o < o - t ? a : t),
					...
					setTranslate: () => {
						...
						for (let e = 0; e < a.length; e += 1) {
							...
							s % 4 == 0
								...
								n && (h = -h),
								p || ((f = h), (h = 0));
							const v = `rotateX(${p ? 0 : -i}deg) rotateY(${p
								? i
								: 0}deg) translate3d(${h}px, ${f}px, ${g}px)`;
							if (
								...
								0 === e.length &&
									((e = d(`<div class="swiper-slide-shadow-${p ? 'left' : 'top'}"></div>`)),
									t.append(e)),
									0 === s.length &&
										((s = d(`<div class="swiper-slide-shadow-${p ? 'right' : 'bottom'}"></div>`)),
										t.append(s)),
						...
						s.transform(
							`translate3d(0px,0,${f}px) rotateX(${e.isHorizontal()
								? 0
								: m}deg) rotateY(${e.isHorizontal() ? -m : 0}deg)`
						);
					},
					setTransition: (t) => {
							...
							if (
								((u =
									c < 0
										...
										: c > 0 ? `calc(${u}px + (-${v * Math.abs(c)}%))` : `${u}px`),
								!e.isHorizontal())
							) {
								const e = h;
								(h = u), (u = e);
