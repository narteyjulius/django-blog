!(function(t, e) {
	...
	const t = 'transitionend',
		...
		r = (t) =>
			o(t) ? (t.jquery ? t[0] : t) : 'string' == typeof t && t.length > 0 ? document.querySelector(t) : null,
		a = (t, e, i) => {
			Object.keys(i).forEach((n) => {
				const s = i[n],
					...
					a =
						r && o(r)
							? 'element'
							: null == (l = r) ? `${l}` : {}.toString.call(l).match(/\s([a-z]+)/i)[1].toLowerCase();
				var l;
	...
	class st extends B {
		...
		_getConfig(t) {
			return (
				(t = { ...X, ...U.getDataAttributes(this._element), ...('object' == typeof t ? t : {}) }), a(K, t, Y), t
			);
		}
		_handleSwipe() {
		...
		_getItemIndex(t) {
			return (
				(this._items = t && t.parentNode ? V.find('.carousel-item', t.parentNode) : []), this._items.indexOf(t)
			);
		}
		_getItemByOrder(t, e) {
			const i = t === Q;
			...
			if (o && r) {
				var h = (function(t, e) {
						return re(
							'number' !=
							typeof (t =
								'function' == typeof t ? t(Object.assign({}, e.rects, { placement: e.placement })) : t)
								? t
								: ae(t, yt)
						);
					})(s.padding, i),
	...
	function de(t) {
		...
		return l
			...
			: Object.assign(
					{},
					O,
					(((e = {})[v] = _ ? m + 'px' : ''), (e[b] = g ? f + 'px' : ''), (e.transform = ''), e)
				);
	}
	const ue = {
		name: 'computeStyles',
				...
				: Te(
						(function(t) {
							var e,
								...
								l = -n.scrollTop;
							return (
								'rtl' === Yt(s || i).direction && (a += ie(i.clientWidth, s ? s.clientWidth : 0) - o),
	...
	class bi {
		...
		_getConfig(t) {
			return (
				((t = { ...pi, ...('object' == typeof t ? t : {}) }).rootElement = r(t.rootElement)),
				a('backdrop', t, mi),
				t
			);
		}
	...
	class Hi extends B {
		...
		_getConfig(t) {
			return (
				(t = { ...Ci, ...U.getDataAttributes(this._element), ...('object' == typeof t ? t : {}) }),
				a(Ti, t, ki),
				t
			);
		}
	...
	class Fi extends B {
				...
				this._queueCallback(
					() => {
						this._config.scroll || this._focustrap.activate(),
							j.trigger(this._element, 'shown.bs.offcanvas', { relatedTarget: t });
					},
					this._element,
					!0
				));
		...
		_getConfig(t) {
			return (
				(t = { ...Ri, ...U.getDataAttributes(this._element), ...('object' == typeof t ? t : {}) }),
				a(Bi, t, Wi),
				t
			);
		}
		...
		setElementContent(t, e) {
			if (null !== t)
				return o(e)
					...
					: void (this._config.html
							? (this._config.sanitize && (e = Yi(e, this._config.allowList, this._config.sanitizeFn)),
								(t.innerHTML = e))
							: (t.textContent = e));
		}
		getTitle() {
	...
	class xn extends B {
		...
		show() {
			...
			if (
				j.trigger(this._element, 'show.bs.tab', { relatedTarget: t }).defaultPrevented ||
